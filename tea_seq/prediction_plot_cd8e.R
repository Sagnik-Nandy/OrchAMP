...
predicted_embedding = read.csv("predicted_embeddings_set_full_set_rna_cd16m.csv")
...
predicted_cell_names_3 = read.csv("labels_projected_test_full_store_full_set_rna_cd16m.csv")
...
p4 = DimPlot(umap_together_2,group.by=cell_names_prediction_set_2,pt.size=0.04,cols = c("grey", "red"))+ theme(legend.position = "none")+ggtitle("Prediction Set: RNA (CD8 Effector)")+theme(plot.title = element_text(hjust = 0.5))



predicted_embedding = read.csv("predicted_embeddings_set_full_set_prot_cd16m.csv")
predicted_embedding = as.matrix(predicted_embedding[,-c(1)])
rownames(predicted_embedding) = paste("p", 1:1:dim(predicted_embedding)[1])
...
predicted_cell_names_3 = read.csv("labels_projected_test_full_store_full_set_prot_cd16m.csv")
predicted_cell_names_3 = as.matrix(predicted_cell_names_3[,-1])
colnames(predicted_cell_names_3) <- "X0"
...
p5 = DimPlot(umap_together_2,group.by=cell_names_prediction_set_2,pt.size=0.04,cols = c("grey", "red"))+ theme(legend.position = "none")+ggtitle("Prediction Set: Protein (CD8 Effector)")+theme(plot.title = element_text(hjust = 0.5))




predicted_embedding = read.csv("predicted_embeddings_set_full_set_atac_cd16m.csv")
predicted_embedding = as.matrix(predicted_embedding[,-c(1)])
rownames(predicted_embedding) = paste("p", 1:1:dim(predicted_embedding)[1])
...
predicted_cell_names_3 = read.csv("labels_projected_test_full_store_full_set_atac_cd16m.csv")
predicted_cell_names_3 = as.matrix(predicted_cell_names_3[,-1])
colnames(predicted_cell_names_3) <- "X0"
...
p6 = DimPlot(umap_together_2,group.by=cell_names_prediction_set_2,pt.size=0.04,cols = c("grey", "red"))+ theme(legend.position = "none")+ggtitle("Prediction Set: ATAC (CD8 Effector)")+theme(plot.title = element_text(hjust = 0.5))
...
ggsave("tea_seq_prediction_cd16m_all_three.pdf", p7, height = 10, width = 10)
ggsave("tea_seq_prediction_cd16m_all_three.png", p7, height = 10, width = 10)
