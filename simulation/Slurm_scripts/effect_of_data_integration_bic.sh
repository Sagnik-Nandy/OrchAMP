...
#SBATCH --mem=32G
#SBATCH --array=0-17                    # 2 settings Ã 3 lambdas Ã 3 rhos = 18 tasks; run up to 6 at once
...
# Prefer envâs libs (often helps with rpy2/pyzmq)
...
"$CONDA_PREFIX/bin/python" \
  "/home/nandy.15/Research/Experiments_revision/Python_Scripts/effect_of_data_integration_bic.py" \
  "$setting" "$lam" "$rho"
